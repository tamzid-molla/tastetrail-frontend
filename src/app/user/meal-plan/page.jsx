...
const MealPlanPage = () => {
  const { data, isLoading, refetch } = useGetMyMealPlansQuery();
  ...
  const handleDelete = async (planId) => {
    if (!confirm("Are you sure you want to remove this from your meal plan?")) {
      return;
    }
    try {
      await deleteMealPlan(planId).unwrap();
